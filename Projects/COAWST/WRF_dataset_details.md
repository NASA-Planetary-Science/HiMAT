...
<sup>2</sup> Use caution if comparing these variables by name to other WRF output. COAWST output has been post-processed to sum the WRF base and perturbation components (pressure and geopotential) and temperature is converted from potential temperature.   
