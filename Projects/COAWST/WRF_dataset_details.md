...
<sup>2</sup> Use caution if comparing these variables by name to other WRF output. COAWST output has been post-processed to sum the WRF base and perturbation components for both pressure and geopotential and WRF potential temperature to converted to air temperature.   
