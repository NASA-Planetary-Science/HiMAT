...
| <sup>2</sup> Air Temperature | T | K | x, y, z, t | no |  | X |  |  |
| Air Temperature at 2m | T2 | K | x, y, t | no | X | X | X | X |
| <sup>2</sup> Air Pressure | P | Pa | x, y, z, t | no |  | X |  |  |
...
| <sup>2</sup> Geopotential | PH | m<sup>2 </sup> s<sup>-2</sup> | x, y, z, t | yes, z |  | X |  |  |
...
| <sup>3</sup> Wind (X-dir) at 10 m | U10 | m s<sup>-1</sup> | x, y, t | no | X | X | X | X |
| <sup>3</sup> Wind (X-dir) | U | m s<sup>-1</sup> | x, y, z, t | yes, u |  | X |  |  |
| <sup>3</sup> Wind (Y-dir) at 10 m | V10 | m s<sup>-1</sup> | x, y, t | no | X | X | X | X |
| <sup>3</sup> Wind (Y-dir) | V |m s<sup>-1</sup> | x, y, z, t | yes, v |  | X |  |  |
...
<sup>2</sup> Use caution if comparing these variables by name to other WRF output. COAWST output has been post-processed to sum the WRF base and perturbation components for both pressure and geopotential and temperature is converted from thr raw potential temperature information.   

<sup>3</sup> Winds generated by WRF are grid-relative. To calculate Earth-relative winds, you will need to apply the following conversion formula: Uearth = Umodel x COSALPHA + Vmodel x SINALPHA; Vearth = Vmodel x COSALPHA + Umodel x SINALPHA 
